...
EVENTS_T1 = [
    {"name": "Mild Winter", "description": "Food production is reduced by 1 this turn.", "threat": 5, "food_modifier": -1, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Animal Migration", "description": "Add 2 to your total Hunt score this turn.", "threat": 6, "food_modifier": 0, "hunt_modifier": 2, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Calm Skies", "description": "Everything is going smoothly. No additional effects.", "threat": 5, "food_modifier": 0, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Rocky Terrain", "description": "Subtract 3 from your total Hunt score this turn.", "threat": 3, "food_modifier": 0, "hunt_modifier": -3, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Local Thieves", "description": "Lose 3 stored Food before allocation.", "threat": 5, "food_modifier": 0, "hunt_modifier": 0, "food_loss": 3, "kinship_modifier": 0, "prayer_modifier": 0},
]
...
EVENTS_T2 = [
    ...
    {"name": "Predator Activity", "description": "Food production is reduced by 2, and the Hunt score is reduced by 2.", "threat": 7, "food_modifier": -2, "hunt_modifier": -2, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Fertile Season", "description": "Food production increases by 1 this turn.", "threat": 5, "food_modifier": 1, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Obsidian Deposit", "description": "Each Worship roll that produces a Prayer Token produces 1 additional Prayer Token this turn.", "threat": 6, "food_modifier": 0, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 1},
    {"name": "Spiritual Awakening", "description": "Each Worship roll that produces a Prayer Token produces 1 additional Prayer Token this turn.", "threat": 8, "food_modifier": 0, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 1},
]

EVENTS_T3 = [
    {"name": "Endless Winter", "description": "Food production is reduced by 2 this turn and 5 stored Food is lost.", "threat": 12, "food_modifier": -2, "hunt_modifier": 0, "food_loss": 5, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Mammoth Herd", "description": "Add 3 to your total Hunt score this turn.", "threat": 14, "food_modifier": 0, "hunt_modifier": 3, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Epidemic", "description": "Food production is reduced by 1 this turn, and Kinship projects started this turn take 1 additional turn to complete.", "threat": 13, "food_modifier": -1, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 1, "prayer_modifier": 0},
    {"name": "Great Flood", "description": "Lose 8 stored Food before allocation, and Food production is reduced by 1 this turn.", "threat": 12, "food_modifier": -1, "hunt_modifier": 0, "food_loss": 8, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Eclipse", "description": "Each Worship roll that produces a Prayer Token produces 1 additional Prayer Token this turn.", "threat": 13, "food_modifier": 0, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 1},
]

EVENTS_T4 = [
    {"name": "Great Famine", "description": "Food production is reduced by 2, and 10 stored Food is lost before allocation.", "threat": 15, "food_modifier": -2, "hunt_modifier": 0, "food_loss": 10, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Stampede", "description": "Add 4 to your total Hunt score this turn, but the Hunt Threat is severe.", "threat": 17, "food_modifier": 0, "hunt_modifier": 4, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Plague", "description": "Food production is reduced by 2 this turn, and Kinship projects started this turn take 1 additional turn.", "threat": 16, "food_modifier": -2, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 1, "prayer_modifier": 0},
    {"name": "Drought", "description": "Lose 12 stored Food before allocation and subtract 1 from your total Hunt score.", "threat": 15, "food_modifier": 0, "hunt_modifier": -1, "food_loss": 12, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Prophetic Vision", "description": "Each Worship roll that produces a Prayer Token produces 1 additional Prayer Token this turn.", "threat": 14, "food_modifier": 0, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 1},
]

EVENTS_T5 = [
    {"name": "Great Starvation", "description": "Food production is reduced by 3 this turn and 15 stored Food is lost before allocation.", "threat": 18, "food_modifier": -3, "hunt_modifier": 0, "food_loss": 15, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Colossal Herd", "description": "Add 5 to your total Hunt score this turn.", "threat": 20, "food_modifier": 0, "hunt_modifier": 5, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Wasting Sickness", "description": "Food production is reduced by 2, Kinship projects started this turn take 1 additional turn, and 5 stored Food is lost.", "threat": 19, "food_modifier": -2, "hunt_modifier": 0, "food_loss": 5, "kinship_modifier": 1, "prayer_modifier": 0},
    {"name": "Catastrophic Flood", "description": "Lose 20 stored Food before allocation and subtract 2 from your total Hunt score.", "threat": 18, "food_modifier": 0, "hunt_modifier": -2, "food_loss": 20, "kinship_modifier": 0, "prayer_modifier": 0},
    {"name": "Divine Omen", "description": "Each Worship roll that produces a Prayer Token produces 1 additional Prayer Token this turn, but the Hunt Threat is extreme.", "threat": 17, "food_modifier": 0, "hunt_modifier": 0, "food_loss": 0, "kinship_modifier": 0, "prayer_modifier": 1},
]
...
def choose_technology_upgrade_sim(
    state: GameState,
    category: str = "F"
) -> tuple[str, int]:
    """Choose a deterministic, simple tech upgrade for simulation.

    The caller supplies F or W. The default behavior upgrades the
    weakest face in that category.
    """
    ...
    state.tech_upgrades[category][face] = (
        tech_bonus(state, category, face) + 1
    )
...
# ============================================================
# TECHNOLOGY UPGRADE POLICIES FOR SIMULATION
# ============================================================

def tech_upgrade_lowest_food(
    state: GameState
) -> tuple[str, int]:
    """
    Upgrade the currently weakest Food face.
    """
    return choose_technology_upgrade_sim(state, "F")


def tech_upgrade_random(
    state: GameState,
    rng: random.Random
) -> tuple[str, int]:
    """
    Randomly choose Food or Worship, then randomly choose
    a legal face in that category.
    """
...
def tech_upgrade_highest_food(
    state: GameState
) -> tuple[str, int]:
    """
    Upgrade the currently strongest Food face.
    """
    ...
    state.tech_upgrades["F"][face] = (
        tech_bonus(state, "F", face) + 1
    )
...
def tech_upgrade_alternate(
    state: GameState
) -> tuple[str, int]:
    """
    Alternate Technology upgrades between Food and Worship.

    Whichever category currently has fewer upgrades gets
    the next upgrade. Ties go to Food.
    """

    food_upgrades = sum(state.tech_upgrades["F"].values())
    worship_upgrades = sum(state.tech_upgrades["W"].values())

    if food_upgrades <= worship_upgrades:
        return choose_technology_upgrade_sim(state, "F")
    else:
        return choose_technology_upgrade_sim(state, "W")


def tech_upgrade_random_category_lowest_face(
    state: GameState,
    rng: random.Random
) -> tuple[str, int]:
    """
    Randomly choose Food or Worship, then upgrade the
    weakest face in that category.
    """

    category = rng.choice(["F", "W"])

    return choose_technology_upgrade_sim(state, category)
...
def prepare_turn(state: GameState, rng: random.Random, strategy: str) -> dict:
    ...
    # Version C: prevent very large food stockpiles from becoming permanent safety.
    # A simple 25% spoilage applies to food carried into a turn above 20.
    spoiled_food = 0
    if state.food > 20:
